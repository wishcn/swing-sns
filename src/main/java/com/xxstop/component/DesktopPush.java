 ...
 *
 */
public class DesktopPush implements Runnable{
     ...
     */
    public DesktopPush(int width, int height, int stayTime, int style, String title, String message){
        this.width=width;
        this.height=height;
     ...
     * @param message   提示框内容
     */
    public DesktopPush(int style, String title, String message){
        this.width=250;
        this.height=180;
        this.stayTime=5;
        this.title=title;
